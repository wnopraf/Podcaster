...
export function PodcastSearchData({ data }: { data: Podcaster.PodCast[] }) {
  ...
  return (
    <div className="mx-auto min-h-[75vh]  lg:max-w-full">
      ...
      <div
        id="podcast-list"
        className=" mt-[30vw] grid grid-cols-1 gap-y-[40vw] *:h-max sm:mt-[15vw] sm:grid-cols-2 sm:justify-items-stretch sm:gap-x-16 sm:gap-y-[20vw] lg:mt-[8vw] lg:grid-cols-4 lg:gap-x-8 lg:gap-y-[12vw] xl:mt-20 xl:gap-y-40  "
      >
